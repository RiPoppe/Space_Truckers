...
namespace SpaceTruckers.Controllers
{
    public class PlanetsController : Controller
    {
        private readonly DatabaseContext _context;

        public PlanetsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Planet planet)
        {
            if (id != planet.Id)
            {
                return NotFound();
